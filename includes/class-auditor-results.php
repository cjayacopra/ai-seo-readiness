<?php if (!empty($scores)):
    ...
    <div class="audit-card">
        ...
        <div class="audit-header">
            ...
            <p class="disclaimer">⚠️ This score checks your website’s structure and clarity. It does not include ads,
                backlinks, or social media.</p>
        </div>
        ...
        <div class="audit-body">
            ...
            <?php if ($is_js_reliant): ?>
                ...
                <div class="js-warning">
                    ...
                    <p>This site appears to rely heavily on JavaScript
                        (<?php echo esc_html($js_analysis['detected_framework']); ?>) to display content. Many AI bots cannot
                        execute JavaScript and may see your site as a blank page.</p>
            ...
            <div class="audit-score">
                <svg viewBox="0 0 220 220">
                    <defs>
                        ...
                        <linearGradient id="scoreGradient" gradientUnits="userSpaceOnUse" x1="0" y1="0" x2="220" y2="220">
                    ...
                    <!-- progress ring -->
                    <circle cx="110" cy="110" r="100" class="progress"
            ...
            <div class="audit-metrics">
                ...
                $rows = [
                    ...
                    'Readability' => bar($scores['readability'], 100),
                    'Image Alt Text' => bar($scores['image_alt'], 100),
                                ...
                                <div class="evidence-header">
                                    ...
                                    <?php if (!empty($item['category'])): ?>
                                        <span class="evidence-category"
                                            style="background:#eee; color:#333; padding:2px 6px; border-radius:4px; font-size:11px; margin-right:8px; border:1px solid #ddd;">
